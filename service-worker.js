// Bump the minor version for each release; reserve major bumps for major releases.
const APP_VERSION = "0.2";
const CACHE_NAME = `bike-calories-v${APP_VERSION}`;
const APP_FILES = ["./", "./index.html", "./styles.css", "./app.js", "./calculator.js", "./manifest.webmanifest", "./icons/bicycle_cals.svg", "./icons/bicycle_cals_192.png", "./icons/bicycle_cals_512.png"];
